...
const name = "Devin for Terminal"

// targetPath is Devin for Terminal's own verified project-scoped
// Skills directory (018-multi-agent-skill-integration/research.md #1:
// Devin Docs' "Rules & AGENTS.md" — "project-scoped skills, use
// .devin/skills/<name>/SKILL.md").
const targetPath = ".devin/skills"

// Adapter implements agents.Adapter for Devin for Terminal.
type Adapter struct{}

// New constructs the Devin for Terminal adapter.
...
// <req.ProjectRoot>/.devin/skills byte-for-byte, identical to
// claude.Adapter.Install — Devin for Terminal already scans the same
